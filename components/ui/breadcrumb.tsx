...
export function Breadcrumb({ items }: { items: BreadcrumbItem[] }) {
  return (
    <nav aria-label="パンくず" className="mb-6 text-sm">
      <ol className="font-ui inline-flex flex-wrap items-center gap-2 rounded-full border border-[var(--breadcrumb-border)] bg-[var(--breadcrumb-bg)] px-4 py-2 text-[var(--breadcrumb-text)] shadow-[var(--breadcrumb-shadow)] backdrop-blur-sm">
